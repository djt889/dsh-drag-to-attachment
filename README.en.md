...
BSD-3-Clause — the path-locating code is ported from [bill9109/dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) (BSD-3-Clause). The bundled Everything is freeware by [voidtools](https://www.voidtools.com). See [LICENSE](LICENSE).
