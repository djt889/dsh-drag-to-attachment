 ...
 *     and bounded recursive search). Nothing is ever uploaded or copied.
 *
...
import { access, constants, open, readdir, readFile, stat } from 'node:fs/promises'
...
export async function apply(ctx) {
  ctx.inject(['webServer'], (webCtx) => {
    webCtx.effect(() => {
      ...
      return () => { disposeLocate(); disposeFile() }
    }, 'drag-to-attachment: locator + thumbnail routes')
  })
}
