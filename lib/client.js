...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function renderUserActions(text, timeMs) {
      ...
      if (hasText) {
        items.push(React.createElement('button', { key: 'copy', type: 'button', title: '复制', onClick: function () { copyUserText(text) }, style: userActionStyle() }, '复制'))
        items.push(React.createElement('button', { key: 'edit', type: 'button', title: '编辑', onClick: function () { editUserText(text) }, style: userActionStyle() }, '编辑'))
      }
